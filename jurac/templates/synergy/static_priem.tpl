<div class="cnt clr">
	...
	<tr>
        <td>
			<br><br><h4>СПИСОК ЛИЦ, ПОДАВШИХ ДОКУМЕНТЫ</h4>
			 {custom category="29"  template="news_priem_dop" aviable="global" from="0" limit="1"  order="reads" cache="no"}
		</td>
    </tr>
	<tr>
        <td>
			<br><br><h4>СПИСОК ЛИЦ, РЕКОМЕНДОВАННЫХ К ЗАЧИСЛЕНИЮ</h4>
				{custom category="30"  template="news_priem_dop" aviable="global" from="0" limit="2"  order="reads" cache="no"}
		</td>
    		</tr>
	<tr>
        <td>
			<br><br><h4>Результаты приема</h4>
				{custom category="31"  template="news_priem_dop" aviable="global" from="0" limit="1"  order="reads" cache="no"} 
		</td>
    </tr>
</table>                     
                      <br><br>
			...
			<table border="0" cellspacing="1" cellpadding="0" width="100%" class="catsTable">
				<tbody>
					...
					<td style="width:100%" class="catsTd" valign="top">
						<a href="/rector.html" class="catName">Ректорат</a> 
					</td>
				</tr>[/not-static]
				...
				<tr>
					<td style="width:100%" class="catsTd" valign="top">				
                    <a href="/index.php?do=feedback&user=13" title="Направить вопрос в адрес приёмной комиссии АНО ВО СЮА"><h4 style="color:red">Задать вопрос <br>в адрес приёмной комиссии</h4></a>  
					</td>
				</tr>
			</tbody></table>           
		</div>
