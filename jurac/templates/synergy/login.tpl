...
[not-group=4] 
    <li><a href="http://student.jurac.ru/login/index.php" target="_blank">MOODLE</a></li>
[/not-group]
[group=1, 10, 2]    
...
<div class="login-form">
	<form method="post">
		...
		<div class="log-check clearfix">
            ...
            <center><br><br><li><h1><a href="http://student.jurac.ru/" target="_blank">Войти MOODLE</a></h1></li></center> 
