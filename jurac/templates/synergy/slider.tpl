	...
	<div id="slider">
		...
		<div class="slide" data-image="{THEME}/images/slider/slide-3.jpg">
			<div class="slide-content">
			    ...
			    <p class="slide-text">22 ГОДА САНКТ-ПЕТЕРБУРГСКОЙ ЮРИДИЧЕСКОЙ АКАДЕМИИ</p>
			    <a href="/congratulation/" class="more-1">Поздравления академии<span>></span></a>
			</div>
		</div>
	</div>
    <span class="slide-arrow fa fa-angle-left" title="Предыдущий слайд"></span>
	<span class="slide-arrow fa fa-angle-right" title="Следующий слайд"></span>
</div>  