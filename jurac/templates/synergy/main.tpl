    ...
    <div class="cnt clr" data-animated="fadeInUp">
		<div class="col4">
			<div class="pricing-table">			   		
                <a href="http://it.jurac.ru/files/sved-1-0-1.pdf" target="_blank" rel = "noopener"><img src="{THEME}/images/1-1.jpg"></a>
            </div>
		</div>
		<div class="col4">
			<div class="pricing-table current">
              <a href="http://it.jurac.ru/files/sved-1-0-1.pdf" target="_blank" rel = "noopener">  <img src="{THEME}/images/1-2.jpg"></a>
			</div>
		</div>
		<div class="col4">
			<div class="pricing-table">			    
               <a href="http://it.jurac.ru/files/sved-1-0-1.pdf" target="_blank" rel = "noopener"><img src="{THEME}/images/1-3.jpg"></a>
			</div>
		</div>
	</div>
</section>     [/available]     
...
<!-- Подвал -->
    ...
    <footer id="footer" class="section dark">
		<div class="cnt" data-animated="fadeIn">
           ...
           <span class="none"> <a href="http://xn--80abucjiibhv9a.xn--p1ai/" target="_blank" title="Министрерство образования и науки Российской Федерации"><!--Министрерство образования и науки Российской Федерации-->
