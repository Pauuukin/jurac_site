...
[available=main]
        ...
        <div class ="quote">
				<div class="title center" data-animated = "fadeIn">
					<h5 style="color:#FF0000;">Уважаемые абитуриенты!</h5><br><br>
						<h6 class="text-center">
        С 20 июня 2021 года открыт прием документов для поступления на все формы обучения. <br><br>
      </h6>
      
        <h6 class="text-center"> <u><a href="https://abiturient.jurac.ru/regabitur/">Подача документов для поступления в Академию осуществляется через
          электронную систему подачи документов</a></u></h6>
        ...
        +7 (812) 677-00-07<br>
        +7 (921) 564-31-01<br>
        и/или через электронную почту: jurac.spb@mail.ru
      </h6>
	  <hr>
	  <h6 class="text-danger text-center" style="color:#FF0000;">
