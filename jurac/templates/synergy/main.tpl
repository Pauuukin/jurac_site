...
<body id="body">
    <div id="loader">
        <div class="loader-body"><span></span></div>
    </div>
    <div id="wrapper">
        <!--Шапка-->
        <div id="heaser-body">
		...
		<div class="title center" data-animated="fadeIn">
            ...
            <div class="cnt clr">
                ...
                <div class="quote">
                    <div class="title center" data-animated="fadeIn">
                        <h6>Уважаемые абитуриенты!<br><br>
                            ...
                            на сайте в разделе «Абитуриент» → «Календарь приема»</h6>
                        <hr>
                        <h6 style="color:#FF0000;">В связи с распространением новой коронавирусной инфекции (COVID-19)»
                            ...
                            <br>или через <b>контактный телефон (Приемная комиссия) : <br> +7 (921) 951-34-33 <br> +7 (812) 677-00-07 <br> +7 (921) 564-31-01</b> </h6>
                    </div>
                </div>
                ...
                <div class="title center" data-animated="fadeIn">
                    ...
                    <a href="/news">
                        <p class="title-descr"><b>ВСЕ НОВОСТИ</b></p>
                    </a>
                ...
                <div class="title center" data-animated="fadeIn">
                    ...
                    <a href="/ads/">
                        <p class="title-descr"><b>ВСЕ ОБЪЯВЛЕНИЯ</b></p>
                    </a>
                ...
                [available=main]
                <hr><br /><br />{include file="news.tpl"}[/available]
            </div>
        </section>
        [available=main]
            ...
            <div class="why-right">
                ...
                <ul class="why-list">
                    <li data-animated="fadeInRight">
                        <p>
                            <font size="5">Почетный президент Санкт-Петербургской юридической академии,
...
-->
        ...
        <footer id="footer" class="section dark">
            <div class="cnt" data-animated="fadeIn">
                ...
                <span class="none"> <a href="https://minobrnauki.gov.ru/" target="_blank" title="Министрерство науки и высшего образования Российской Федерации">
                ...
                <br><br>
                <span class="none"><a href="javascript://" onclick="uvcl()" alt="Версия для слабовидящих" title="Версия для слабовидящих"><span id="uhvb">
                            <h1 style="color:white;"> Версия для слабовидящих </h1>
                        </span></a></span>
            </div>
        </footer>
        <!-- Код VK_0530 -->
