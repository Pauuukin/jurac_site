			<div class="nav-icon menu-icon"><i class="fa fa-bars" title="Открыть меню" style="font-size: 30px;color: #2f6c90;"></i></div>
				<nav id="nav">
	...
	<ul class="uMenuRoot">
		...
		<li class="uWithSubmenu">
            <a href="/structure-1.html" alt="Структура образовательной организации" title="Пункты меню"><span>Структура<br>Образовательной<br>Организации</span></a>
            <ul>
                ...
                <ul>
                    ...
                    <li><a href="/subfaculty/266-gpd.html"><span>Кафедра государственно-правовых дисциплин</span></a></li>
       ...
       <li class="uWithSubmenu"> <a href="https://jurac.ru/science/277-science-m.html"><span>научная<br>деятельность<br></span></a>
        <ul>
            <li><a href="/science/277-science-m.html">Научная деятельность</a></li>
            <li><a href="/scince-result-stud/">Достижения наших студентов</a></li>
            <li><a href="/science/276-c-a-g.html">Конкурсы и гранты</a></li>
            <li><a href="/science-events/">Конференции, семинары и другие мероприятия</a></li>
